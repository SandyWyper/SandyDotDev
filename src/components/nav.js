...
const Nav = props => {
  ...
  return (
    <animated.nav
      style={revealSpring}
      className="fixed inset-x-0 z-30 w-full nav"
    >
      <animated.div
        style={titleSpring}
        className="container relative flex items-center w-full mx-auto md:flex-col md:my-auto nav-inner"
      >
        <Link to="/" className="ml-4 md:ml-0 background-prmary">
          <svg className="site-title" viewBox="0 0 237 36">
