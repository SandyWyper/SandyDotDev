          ...
          <div className="max-w-3xl px-4 pb-40 mx-auto md:px-0">
            ...
            <p className="inline-block pl-4 mb-6">
              ...
              <PictureToolTip
                ...
                title={
                  <div>
                    <img src={architecturePhoto} alt="architectural section" />
                  </div>
                }
              >
                <span>architecture&nbsp;</span>
              </PictureToolTip>
              from the University of Dundee, and after working in various places
              and jobs moved permenantly to Cornwall. I was lucky enough to get
              a job working for the RNLI as a&nbsp;
              <PictureToolTip
                className="inline-block photo-tip"
                arrow
                TransitionComponent={Zoom}
              ...
              job, but when I started learning to code, I knew I was ready for a
              new challenge.
            </p>
            ...
            <p className="pl-4 mb-4">
              ...
              previously worked for LinedUp, Shopify Experts. Here's a list of
              strings to my bow:
            </p>
            ...
            <p className="pl-4 mb-4">
              Please take a look through my side projects, or have a look at the
              repo for this site{" "}
              <a
